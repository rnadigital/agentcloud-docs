...
<CardGroup cols = {2}>
    ...
    <Card title = "Sales Insights" icon = "messages-dollar" horizontal href = "">
        A sales app that allows you to find out what products are performing well and general sales trends within the data.
    </Card>
